...
class SeriesControllerTest < ActionController::TestCase
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post :create, series: { calendar_id: @series.calendar_id, description: @series.description, feeds_id: @series.feeds_id, logo: @series.logo, name: @series.name }
    end
  ...
  test "should update series" do
    patch :update, id: @series, series: { calendar_id: @series.calendar_id, description: @series.description, feeds_id: @series.feeds_id, logo: @series.logo, name: @series.name }
    assert_redirected_to series_path(assigns(:series))
  end
